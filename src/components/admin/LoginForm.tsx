...
export default function LoginForm() {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      {error && (
        <div className="rounded-md bg-red-50 p-4 mb-6 border border-red-200 animate-fadeIn">
          <div className="flex">
      ...
      <div className="space-y-2">
        ...
        <div className="mt-1 relative rounded-md shadow-sm">
          ...
          <input
            ...
            placeholder="admin@atlanticguttersupply.com"
      ...
      <div className="pt-2">
        <button
          type="submit"
          disabled={isLoading}
          className="flex w-full justify-center rounded-md bg-blue-600 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
        >
          {isLoading ? (
            <>
