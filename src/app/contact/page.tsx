...
export const metadata: Metadata = {
  title: "Contact Us | Atlantic Gutter Supply",
  description: "Contact Atlantic Gutter Supply for inquiries about our products or to request a quote.",
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-gray-500">
              Have questions about our products or need a custom quote? Fill out the form below and our team will get back to you as soon as possible.
            </p>
            ...
            <div className="mt-6">
              <div className="flex">
                ...
                <div className="ml-3 text-base text-gray-500">
                  <p>123 Gutter Lane</p>
                  <p className="mt-1">Atlantic City, NJ 08401</p>
                </div>
              </div>
              ...
              <div className="mt-6 flex">
                ...
                <div className="ml-3 text-base text-gray-500">
                  <p>info@atlanticguttersupply.com</p>
                </div>
              </div>

              <div className="mt-8">
                <h3 className="text-lg font-medium text-gray-900">Business Hours</h3>
                <div className="mt-3 space-y-1 text-base text-gray-500">
